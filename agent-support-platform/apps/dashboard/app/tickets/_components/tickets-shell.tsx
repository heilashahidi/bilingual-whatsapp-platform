    ...
    <div className="space-y-4">
      ...
      {isInbox && (
        <div className="flex h-[calc(100vh-16rem)] min-h-[32rem] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="w-[22rem] shrink-0 overflow-hidden border-r border-slate-200">
      ...
      {/* Kanban + List share the inbox sidebar but skip the right pane.
          The slide-in drawer still mounts for them so clicking a card
          opens the detail without leaving the view. */}
      {!isInbox && (
        <div className="flex h-[calc(100vh-16rem)] min-h-[32rem] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <InboxSidebar tickets={visible} />
